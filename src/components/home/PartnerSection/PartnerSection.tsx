...
const SERVIZI = [
  {
    nome: "Energia e gas",
    descrizione:
      "Attivazioni, volture e assistenza sulle utenze.",
    icona: FiZap,
    variante: "green",
  },
  {
    ...
    descrizione:
      "Offerte casa, mobile e connettività.",
    icona: FiPhone,
    variante: "blue",
  },
  {
    nome: "Assicurazioni",
    descrizione:
      "Supporto nella scelta delle principali coperture.",
    icona: FiShield,
    variante: "fuchsia",
  },
  {
    nome: "Noleggio auto",
    descrizione:
      "Soluzioni di mobilità per privati e aziende.",
    icona: FiBriefcase,
    variante: "orange",
  },
  {
    ...
    descrizione:
      "Punti di ritiro, invii e servizi logistici.",
    icona: FiTruck,
    variante: "blue",
  },
  {
    nome: "Amazon Hub",
    descrizione:
      "Ritiro e gestione delle consegne presso la sede.",
    icona: FiBox,
    variante: "green",
  },
  {
    ...
    descrizione:
      "Prestiti, mutui e cessione del quinto.",
    icona: FiCreditCard,
    variante: "fuchsia",
  },
  {
    ...
    descrizione:
      "Una rete di servizi integrati per cittadini e imprese.",
    icona: FiHome,
    variante: "orange",
  },
  {
    ...
    descrizione:
      "Siti web, gestionali e servizi digitali su misura.",
    icona: FiMonitor,
    variante: "petrol",
  },
  {
    nome: "Servizi online",
    descrizione:
      "Supporto digitale e assistenza anche da remoto.",
    icona: FiGlobe,
    variante: "blue",
  },
];
      ...
      <div className="partners-section__container">
        <div className="partners-section__heading">
          ...
          <p className="partners-section__description">
            Dalle utenze alla logistica,
            dai servizi finanziari alle
            soluzioni digitali: presso la
            sede trovi assistenza per tante
            esigenze quotidiane.
          </p>
        </div>
