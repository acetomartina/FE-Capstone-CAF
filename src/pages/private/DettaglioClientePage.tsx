...
import { FiArrowLeft, FiArrowRight, FiCalendar, FiCheckCircle, FiClock, FiEdit3, FiFileText, FiMail, FiPhone, FiPlus, FiRefreshCw, FiUser } from "react-icons/fi";
...
import ModificaClienteModal from "../../features/clienti/components/ModificaClienteModal";
import NuovoTesseramentoModal from "../../features/clienti/components/NuovoTesseramentoModal";
  ...
  return (
    <section className="dettaglio-cliente-page">
      ...
      <NuovoTesseramentoModal
        mostraModal={mostraModalTesseramento}
        suChiusura={chiudiModalTesseramento}
        dataScelta={dataTesseramento}
        suCambioData={setDataTesseramento}
        noteScelte={noteTesseramento}
        suCambioNote={setNoteTesseramento}
        suRegistrazione={registraTesseramento}
        inSalvataggio={salvataggioTesseramento}
        messaggioErrore={erroreTesseramento}
      />

      <ModificaClienteModal
        mostraModal={mostraModalModifica}
        suChiusura={chiudiModalModifica}
        valoriForm={formModifica}
        aggiornaCampo={aggiornaCampo}
        suSalvataggio={salvaModificheCliente}
        inSalvataggio={salvataggioCliente}
        messaggioErrore={erroreModifica}
      />
    </section>
  );
};
